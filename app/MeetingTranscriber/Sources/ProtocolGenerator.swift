...
enum ProtocolError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case let .generationTimedOut(seconds): "Protocol generation timed out after \(seconds)s. The LLM endpoint is stuck or too slow. Try a smaller model or a shorter context."
